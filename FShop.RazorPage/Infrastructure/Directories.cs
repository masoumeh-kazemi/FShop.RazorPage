...
public class Directories
{
    ...
    public const string ProductContentImage = "/images/Products/ContentImage";
    ...
    public static string GetProductContentImage()
    {
        return $"{SiteSettings.ServerPath}{ProductContentImage}";
    }
